    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-8">
                ...
                <p>hose who choose to access or use the Company Products from other locations, including from outside India, may do so on their own initiative and are responsible for compliance with local laws, if and to the extent local laws are applicable. Access to or use of the Company Products from jurisdictions where the contents or practices of the Company Products are illegal, unauthorized or penalized is strictly prohibited.</p>
            </div>
            <div class="col-sm-2"></div>
        </div>
    </div>
